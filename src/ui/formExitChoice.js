...
export function showIncompleteFormExitChoice({ onYes, onNo, onStay, documentRef = document } = {}){
  const existing = documentRef.querySelector('.global-incomplete-exit-choice');
  if(existing) return;
